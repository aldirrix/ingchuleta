...
export default function Terms() {
  ...
  return (
    <>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            {' '}
            (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Ing Chuleta.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            ...
            {' '}
            <a rel="noreferrer" href="https://www.termsfeed.com/terms-conditions-generator/" target="_blank">Terms and Conditions Generator</a>
            .
          </p>
        </li>
        <li>
        ...
        <li>
          <p>
            ...
            {' '}
            refers to Ing Chuleta, accessible from
            {' '}
            <a href="https://ingchuleta.com" rel="noreferrer external nofollow noopener" target="_blank">https://ingchuleta.com</a>
          </p>
        </li>
        <li>
          <p>
      ...
      <ul>
        <li>By email: contact@ingchuleta.com</li>
      </ul>
    </>
  );
}
